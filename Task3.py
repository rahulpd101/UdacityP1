...
def classifyNumber(phoneNum):
    ...
    return {"areaCode": areaCode, "prefix": prefix}
...
for record in calls_Bangalore:
    if(record[1].startswith(bangaloreAreaCode)):
        countRecords += 1

print("The numbers called by people in Bangalore have codes:")
print(*sorted(set(phoneNumberCodes)), sep='\n')

y = countRecords
x = len(calls_Bangalore)
p = y/x
